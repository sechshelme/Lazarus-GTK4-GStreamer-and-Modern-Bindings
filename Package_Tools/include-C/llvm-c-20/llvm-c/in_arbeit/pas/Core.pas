...
function LLVMIsAArgument(Val: PLLVMValueRef): PLLVMValueRef; cdecl; external libllvm;
function LLVMIsABasicBlock(Val: PLLVMValueRef): PLLVMValueRef; cdecl; external libllvm;
function LLVMIsAInlineAsm(Val: PLLVMValueRef): PLLVMValueRef; cdecl; external libllvm;
function LLVMIsAUser(Val: PLLVMValueRef): PLLVMValueRef; cdecl; external libllvm;
function LLVMIsAConstant(Val: PLLVMValueRef): PLLVMValueRef; cdecl; external libllvm;
function LLVMIsABlockAddress(Val: PLLVMValueRef): PLLVMValueRef; cdecl; external libllvm;
function LLVMIsAConstantAggregateZero(Val: PLLVMValueRef): PLLVMValueRef; cdecl; external libllvm;
function LLVMIsAConstantArray(Val: PLLVMValueRef): PLLVMValueRef; cdecl; external libllvm;
function LLVMIsAConstantDataSequential(Val: PLLVMValueRef): PLLVMValueRef; cdecl; external libllvm;
function LLVMIsAConstantDataArray(Val: PLLVMValueRef): PLLVMValueRef; cdecl; external libllvm;
function LLVMIsAConstantDataVector(Val: PLLVMValueRef): PLLVMValueRef; cdecl; external libllvm;
function LLVMIsAConstantExpr(Val: PLLVMValueRef): PLLVMValueRef; cdecl; external libllvm;
function LLVMIsAConstantFP(Val: PLLVMValueRef): PLLVMValueRef; cdecl; external libllvm;
function LLVMIsAConstantInt(Val: PLLVMValueRef): PLLVMValueRef; cdecl; external libllvm;
function LLVMIsAConstantPointerNull(Val: PLLVMValueRef): PLLVMValueRef; cdecl; external libllvm;
function LLVMIsAConstantStruct(Val: PLLVMValueRef): PLLVMValueRef; cdecl; external libllvm;
function LLVMIsAConstantTokenNone(Val: PLLVMValueRef): PLLVMValueRef; cdecl; external libllvm;
function LLVMIsAConstantVector(Val: PLLVMValueRef): PLLVMValueRef; cdecl; external libllvm;
function LLVMIsAConstantPtrAuth(Val: PLLVMValueRef): PLLVMValueRef; cdecl; external libllvm;
function LLVMIsAGlobalValue(Val: PLLVMValueRef): PLLVMValueRef; cdecl; external libllvm;
function LLVMIsAGlobalAlias(Val: PLLVMValueRef): PLLVMValueRef; cdecl; external libllvm;
function LLVMIsAGlobalObject(Val: PLLVMValueRef): PLLVMValueRef; cdecl; external libllvm;
function LLVMIsAFunction(Val: PLLVMValueRef): PLLVMValueRef; cdecl; external libllvm;
function LLVMIsAGlobalVariable(Val: PLLVMValueRef): PLLVMValueRef; cdecl; external libllvm;
function LLVMIsAGlobalIFunc(Val: PLLVMValueRef): PLLVMValueRef; cdecl; external libllvm;
function LLVMIsAUndefValue(Val: PLLVMValueRef): PLLVMValueRef; cdecl; external libllvm;
function LLVMIsAPoisonValue(Val: PLLVMValueRef): PLLVMValueRef; cdecl; external libllvm;
function LLVMIsAInstruction(Val: PLLVMValueRef): PLLVMValueRef; cdecl; external libllvm;
function LLVMIsAUnaryOperator(Val: PLLVMValueRef): PLLVMValueRef; cdecl; external libllvm;
function LLVMIsABinaryOperator(Val: PLLVMValueRef): PLLVMValueRef; cdecl; external libllvm;
function LLVMIsACallInst(Val: PLLVMValueRef): PLLVMValueRef; cdecl; external libllvm;
function LLVMIsAIntrinsicInst(Val: PLLVMValueRef): PLLVMValueRef; cdecl; external libllvm;
function LLVMIsADbgInfoIntrinsic(Val: PLLVMValueRef): PLLVMValueRef; cdecl; external libllvm;
function LLVMIsADbgVariableIntrinsic(Val: PLLVMValueRef): PLLVMValueRef; cdecl; external libllvm;
function LLVMIsADbgDeclareInst(Val: PLLVMValueRef): PLLVMValueRef; cdecl; external libllvm;
function LLVMIsADbgLabelInst(Val: PLLVMValueRef): PLLVMValueRef; cdecl; external libllvm;
function LLVMIsAMemIntrinsic(Val: PLLVMValueRef): PLLVMValueRef; cdecl; external libllvm;
function LLVMIsAMemCpyInst(Val: PLLVMValueRef): PLLVMValueRef; cdecl; external libllvm;
function LLVMIsAMemMoveInst(Val: PLLVMValueRef): PLLVMValueRef; cdecl; external libllvm;
function LLVMIsAMemSetInst(Val: PLLVMValueRef): PLLVMValueRef; cdecl; external libllvm;
function LLVMIsACmpInst(Val: PLLVMValueRef): PLLVMValueRef; cdecl; external libllvm;
function LLVMIsAFCmpInst(Val: PLLVMValueRef): PLLVMValueRef; cdecl; external libllvm;
function LLVMIsAICmpInst(Val: PLLVMValueRef): PLLVMValueRef; cdecl; external libllvm;
function LLVMIsAExtractElementInst(Val: PLLVMValueRef): PLLVMValueRef; cdecl; external libllvm;
function LLVMIsAGetElementPtrInst(Val: PLLVMValueRef): PLLVMValueRef; cdecl; external libllvm;
function LLVMIsAInsertElementInst(Val: PLLVMValueRef): PLLVMValueRef; cdecl; external libllvm;
function LLVMIsAInsertValueInst(Val: PLLVMValueRef): PLLVMValueRef; cdecl; external libllvm;
function LLVMIsALandingPadInst(Val: PLLVMValueRef): PLLVMValueRef; cdecl; external libllvm;
function LLVMIsAPHINode(Val: PLLVMValueRef): PLLVMValueRef; cdecl; external libllvm;
function LLVMIsASelectInst(Val: PLLVMValueRef): PLLVMValueRef; cdecl; external libllvm;
function LLVMIsAShuffleVectorInst(Val: PLLVMValueRef): PLLVMValueRef; cdecl; external libllvm;
function LLVMIsAStoreInst(Val: PLLVMValueRef): PLLVMValueRef; cdecl; external libllvm;
function LLVMIsABranchInst(Val: PLLVMValueRef): PLLVMValueRef; cdecl; external libllvm;
function LLVMIsAIndirectBrInst(Val: PLLVMValueRef): PLLVMValueRef; cdecl; external libllvm;
function LLVMIsAInvokeInst(Val: PLLVMValueRef): PLLVMValueRef; cdecl; external libllvm;
function LLVMIsAReturnInst(Val: PLLVMValueRef): PLLVMValueRef; cdecl; external libllvm;
function LLVMIsASwitchInst(Val: PLLVMValueRef): PLLVMValueRef; cdecl; external libllvm;
function LLVMIsAUnreachableInst(Val: PLLVMValueRef): PLLVMValueRef; cdecl; external libllvm;
function LLVMIsAResumeInst(Val: PLLVMValueRef): PLLVMValueRef; cdecl; external libllvm;
function LLVMIsACleanupReturnInst(Val: PLLVMValueRef): PLLVMValueRef; cdecl; external libllvm;
function LLVMIsACatchReturnInst(Val: PLLVMValueRef): PLLVMValueRef; cdecl; external libllvm;
function LLVMIsACatchSwitchInst(Val: PLLVMValueRef): PLLVMValueRef; cdecl; external libllvm;
function LLVMIsACallBrInst(Val: PLLVMValueRef): PLLVMValueRef; cdecl; external libllvm;
function LLVMIsAFuncletPadInst(Val: PLLVMValueRef): PLLVMValueRef; cdecl; external libllvm;
function LLVMIsACatchPadInst(Val: PLLVMValueRef): PLLVMValueRef; cdecl; external libllvm;
function LLVMIsACleanupPadInst(Val: PLLVMValueRef): PLLVMValueRef; cdecl; external libllvm;
function LLVMIsAUnaryInstruction(Val: PLLVMValueRef): PLLVMValueRef; cdecl; external libllvm;
function LLVMIsAAllocaInst(Val: PLLVMValueRef): PLLVMValueRef; cdecl; external libllvm;
function LLVMIsACastInst(Val: PLLVMValueRef): PLLVMValueRef; cdecl; external libllvm;
function LLVMIsAAddrSpaceCastInst(Val: PLLVMValueRef): PLLVMValueRef; cdecl; external libllvm;
function LLVMIsABitCastInst(Val: PLLVMValueRef): PLLVMValueRef; cdecl; external libllvm;
function LLVMIsAFPExtInst(Val: PLLVMValueRef): PLLVMValueRef; cdecl; external libllvm;
function LLVMIsAFPToSIInst(Val: PLLVMValueRef): PLLVMValueRef; cdecl; external libllvm;
function LLVMIsAFPToUIInst(Val: PLLVMValueRef): PLLVMValueRef; cdecl; external libllvm;
function LLVMIsAFPTruncInst(Val: PLLVMValueRef): PLLVMValueRef; cdecl; external libllvm;
function LLVMIsAIntToPtrInst(Val: PLLVMValueRef): PLLVMValueRef; cdecl; external libllvm;
function LLVMIsAPtrToIntInst(Val: PLLVMValueRef): PLLVMValueRef; cdecl; external libllvm;
function LLVMIsASExtInst(Val: PLLVMValueRef): PLLVMValueRef; cdecl; external libllvm;
function LLVMIsASIToFPInst(Val: PLLVMValueRef): PLLVMValueRef; cdecl; external libllvm;
function LLVMIsATruncInst(Val: PLLVMValueRef): PLLVMValueRef; cdecl; external libllvm;
function LLVMIsAUIToFPInst(Val: PLLVMValueRef): PLLVMValueRef; cdecl; external libllvm;
function LLVMIsAZExtInst(Val: PLLVMValueRef): PLLVMValueRef; cdecl; external libllvm;
function LLVMIsAExtractValueInst(Val: PLLVMValueRef): PLLVMValueRef; cdecl; external libllvm;
function LLVMIsALoadInst(Val: PLLVMValueRef): PLLVMValueRef; cdecl; external libllvm;
function LLVMIsAVAArgInst(Val: PLLVMValueRef): PLLVMValueRef; cdecl; external libllvm;
function LLVMIsAFreezeInst(Val: PLLVMValueRef): PLLVMValueRef; cdecl; external libllvm;
function LLVMIsAAtomicCmpXchgInst(Val: PLLVMValueRef): PLLVMValueRef; cdecl; external libllvm;
function LLVMIsAAtomicRMWInst(Val: PLLVMValueRef): PLLVMValueRef; cdecl; external libllvm;
function LLVMIsAFenceInst(Val: PLLVMValueRef): PLLVMValueRef; cdecl; external libllvm;
...
function LLVMConstReal(RealTy: TLLVMTypeRef; N: double): TLLVMValueRef; cdecl; external libllvm;
...
function LLVMConstRealGetDouble(ConstantVal: TLLVMValueRef; losesInfo: PLLVMBool): double; cdecl; external libllvm;
...
function LLVMConstStructInContext(C: TLLVMContextRef; ConstantVals: PLLVMValueRef; Count: dword; Pack: TLLVMBool): TLLVMValueRef; cdecl; external libllvm;
function LLVMConstStruct(ConstantVals: PLLVMValueRef; Count: dword; Pack: TLLVMBool): TLLVMValueRef; cdecl; external libllvm;
...
function LLVMGetElementAsConstant(C: TLLVMValueRef; idx: dword): TLLVMValueRef; cdecl; external libllvm; deprecated;
...
function LLVMConstNUWNeg(ConstantVal: TLLVMValueRef): TLLVMValueRef; cdecl; external libllvm; deprecated;
...
function LLVMGetIntrinsicDeclaration(Mod_: TLLVMModuleRef; ID: dword; ParamTypes: PLLVMTypeRef; ParamCount: Tsize_t): TLLVMValueRef; cdecl; external libllvm;
...
function LLVMIntrinsicCopyOverloadedName2(Mod_: TLLVMModuleRef; ID: dword; ParamTypes: PLLVMTypeRef; ParamCount: Tsize_t; NameLength: Psize_t): pchar; cdecl; external libllvm;
...
function LLVMBuildCondBr(para1: TLLVMBuilderRef; If_: TLLVMValueRef; Then_: TLLVMBasicBlockRef; Else_: TLLVMBasicBlockRef): TLLVMValueRef; cdecl; external libllvm;
function LLVMBuildSwitch(para1: TLLVMBuilderRef; V: TLLVMValueRef; Else_: TLLVMBasicBlockRef; NumCases: dword): TLLVMValueRef; cdecl; external libllvm;
...
function LLVMBuildInvoke2(para1: TLLVMBuilderRef; Ty: TLLVMTypeRef; Fn: TLLVMValueRef; Args: PLLVMValueRef; NumArgs: dword;
  Then_: TLLVMBasicBlockRef; Catch: TLLVMBasicBlockRef; Name: pchar): TLLVMValueRef; cdecl; external libllvm;
function LLVMBuildInvokeWithOperandBundles(para1: TLLVMBuilderRef; Ty: TLLVMTypeRef; Fn: TLLVMValueRef; Args: PLLVMValueRef; NumArgs: dword;
  Then_: TLLVMBasicBlockRef; Catch: TLLVMBasicBlockRef; Bundles: PLLVMOperandBundleRef; NumBundles: dword; Name: pchar): TLLVMValueRef; cdecl; external libllvm;
...
function LLVMBuildNUWNeg(B: TLLVMBuilderRef; V: TLLVMValueRef; Name: pchar): TLLVMValueRef; cdecl; external libllvm; deprecated;
...
function LLVMBuildSelect(para1: TLLVMBuilderRef; If_: TLLVMValueRef; Then_: TLLVMValueRef; Else_: TLLVMValueRef; Name: pchar): TLLVMValueRef; cdecl; external libllvm;
