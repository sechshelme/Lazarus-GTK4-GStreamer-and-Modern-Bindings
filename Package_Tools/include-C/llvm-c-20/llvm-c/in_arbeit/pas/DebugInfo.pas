...
function LLVMDIBuilderCreateModule(Builder:TLLVMDIBuilderRef; ParentScope:TLLVMMetadataRef; Name:Pchar; NameLen:Tsize_t; ConfigMacros:Pchar; 
           ConfigMacrosLen:Tsize_t; IncludePath:Pchar; IncludePathLen:Tsize_t; APINotesFile:Pchar; APINotesFileLen:Tsize_t):TLLVMMetadataRef;cdecl;external libllvm;
{*
...
function LLVMDIBuilderCreateLexicalBlock(Builder:TLLVMDIBuilderRef; Scope:TLLVMMetadataRef; File:TLLVMMetadataRef; Line:dword; Column:dword):TLLVMMetadataRef;cdecl;external libllvm;
{*
...
function LLVMDIBuilderCreateLexicalBlockFile(Builder:TLLVMDIBuilderRef; Scope:TLLVMMetadataRef; File:TLLVMMetadataRef; Discriminator:dword):TLLVMMetadataRef;cdecl;external libllvm;
{*
...
function LLVMDIBuilderCreateImportedModuleFromNamespace(Builder:TLLVMDIBuilderRef; Scope:TLLVMMetadataRef; NS:TLLVMMetadataRef; File:TLLVMMetadataRef; Line:dword):TLLVMMetadataRef;cdecl;external libllvm;
{*
...
function LLVMDIFileGetDirectory(File:TLLVMMetadataRef; Len:Pdword):Pchar;cdecl;external libllvm;
{*
...
function LLVMDIFileGetFilename(File:TLLVMMetadataRef; Len:Pdword):Pchar;cdecl;external libllvm;
{*
...
function LLVMDIFileGetSource(File:TLLVMMetadataRef; Len:Pdword):Pchar;cdecl;external libllvm;
{*
 * Create a type array.
 * \param Builder        The DIBuilder.
...
function LLVMDIBuilderCreateSubroutineType(Builder:TLLVMDIBuilderRef; File:TLLVMMetadataRef; ParameterTypes:PLLVMMetadataRef; NumParameterTypes:dword; Flags:TLLVMDIFlags):TLLVMMetadataRef;cdecl;external libllvm;
{*
...
function LLVMDIBuilderCreateTempMacroFile(Builder:TLLVMDIBuilderRef; ParentMacroFile:TLLVMMetadataRef; Line:dword; File:TLLVMMetadataRef):TLLVMMetadataRef;cdecl;external libllvm;
{*
...
function LLVMDIVariableGetFile(Var:TLLVMMetadataRef):TLLVMMetadataRef;cdecl;external libllvm;
{*
...
function LLVMDIVariableGetScope(Var:TLLVMMetadataRef):TLLVMMetadataRef;cdecl;external libllvm;
{*
...
function LLVMDIVariableGetLine(Var:TLLVMMetadataRef):dword;cdecl;external libllvm;
{*
...
function LLVMDIBuilderCreateParameterVariable(Builder:TLLVMDIBuilderRef; Scope:TLLVMMetadataRef; Name:Pchar; NameLen:Tsize_t; ArgNo:dword; 
           File:TLLVMMetadataRef; LineNo:dword; Ty:TLLVMMetadataRef; AlwaysPreserve:TLLVMBool; Flags:TLLVMDIFlags):TLLVMMetadataRef;cdecl;external libllvm;
{*
