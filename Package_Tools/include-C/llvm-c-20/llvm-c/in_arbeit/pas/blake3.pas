...
procedure llvm_blake3_hasher_init_keyed(self:Pllvm_blake3_hasher; key:array[0..(LLVM_BLAKE3_KEY_LEN)-1] of Tuint8_t);cdecl;external libllvm;
...
procedure llvm_blake3_hasher_finalize(self:Pllvm_blake3_hasher; out:Puint8_t; out_len:Tsize_t);cdecl;external libllvm;
procedure llvm_blake3_hasher_finalize_seek(self:Pllvm_blake3_hasher; seek:Tuint64_t; out:Puint8_t; out_len:Tsize_t);cdecl;external libllvm;
