...
{
  Automatically converted by H2Pas 1.0.0 from Orc.h
...
PLLVMJITSymbolTargetFlags  = ^LLVMJITSymbolTargetFlags;
PLLVMMemoryBufferRef  = ^LLVMMemoryBufferRef;
PLLVMOrcCDependenceMapPair  = ^LLVMOrcCDependenceMapPair;
PLLVMOrcCDependenceMapPairs  = ^LLVMOrcCDependenceMapPairs;
PLLVMOrcCJITDylibSearchOrder  = ^LLVMOrcCJITDylibSearchOrder;
PLLVMOrcCJITDylibSearchOrderElement  = ^LLVMOrcCJITDylibSearchOrderElement;
PLLVMOrcCLookupSet  = ^LLVMOrcCLookupSet;
...
PLLVMOrcCSymbolAliasMapPairs  = ^LLVMOrcCSymbolAliasMapPairs;
PLLVMOrcCSymbolDependenceGroup  = ^LLVMOrcCSymbolDependenceGroup;
PLLVMOrcCSymbolFlagsMapPair  = ^LLVMOrcCSymbolFlagsMapPair;
PLLVMOrcCSymbolFlagsMapPairs  = ^LLVMOrcCSymbolFlagsMapPairs;
PLLVMOrcCSymbolMapPair  = ^LLVMOrcCSymbolMapPair;
PLLVMOrcCSymbolMapPairs  = ^LLVMOrcCSymbolMapPairs;
...
PLLVMOrcJITTargetAddress  = ^LLVMOrcJITTargetAddress;
...
PLLVMOrcOpaqueDefinitionGenerator  = ^LLVMOrcOpaqueDefinitionGenerator;
PLLVMOrcOpaqueDumpObjects  = ^LLVMOrcOpaqueDumpObjects;
PLLVMOrcOpaqueExecutionSession  = ^LLVMOrcOpaqueExecutionSession;
PLLVMOrcOpaqueIndirectStubsManager  = ^LLVMOrcOpaqueIndirectStubsManager;
PLLVMOrcOpaqueIRTransformLayer  = ^LLVMOrcOpaqueIRTransformLayer;
PLLVMOrcOpaqueJITDylib  = ^LLVMOrcOpaqueJITDylib;
PLLVMOrcOpaqueJITTargetMachineBuilder  = ^LLVMOrcOpaqueJITTargetMachineBuilder;
PLLVMOrcOpaqueLazyCallThroughManager  = ^LLVMOrcOpaqueLazyCallThroughManager;
PLLVMOrcOpaqueLookupState  = ^LLVMOrcOpaqueLookupState;
PLLVMOrcOpaqueMaterializationResponsibility  = ^LLVMOrcOpaqueMaterializationResponsibility;
PLLVMOrcOpaqueMaterializationUnit  = ^LLVMOrcOpaqueMaterializationUnit;
PLLVMOrcOpaqueObjectLayer  = ^LLVMOrcOpaqueObjectLayer;
PLLVMOrcOpaqueObjectLinkingLayer  = ^LLVMOrcOpaqueObjectLinkingLayer;
PLLVMOrcOpaqueObjectTransformLayer  = ^LLVMOrcOpaqueObjectTransformLayer;
PLLVMOrcOpaqueResourceTracker  = ^LLVMOrcOpaqueResourceTracker;
PLLVMOrcOpaqueSymbolStringPool  = ^LLVMOrcOpaqueSymbolStringPool;
PLLVMOrcOpaqueSymbolStringPoolEntry  = ^LLVMOrcOpaqueSymbolStringPoolEntry;
PLLVMOrcOpaqueThreadSafeContext  = ^LLVMOrcOpaqueThreadSafeContext;
PLLVMOrcOpaqueThreadSafeModule  = ^LLVMOrcOpaqueThreadSafeModule;
...
procedure LLVMOrcExecutionSessionSetErrorReporter(ES:TLLVMOrcExecutionSessionRef; ReportError:TLLVMOrcErrorReporterFunction; Ctx:pointer);cdecl;external;
{*
...
function LLVMOrcExecutionSessionGetSymbolStringPool(ES:TLLVMOrcExecutionSessionRef):TLLVMOrcSymbolStringPoolRef;cdecl;external;
{*
...
procedure LLVMOrcSymbolStringPoolClearDeadEntries(SSP:TLLVMOrcSymbolStringPoolRef);cdecl;external;
{*
...
function LLVMOrcExecutionSessionIntern(ES:TLLVMOrcExecutionSessionRef; Name:Pchar):TLLVMOrcSymbolStringPoolEntryRef;cdecl;external;
{*
...
procedure LLVMOrcExecutionSessionLookup(ES:TLLVMOrcExecutionSessionRef; K:TLLVMOrcLookupKind; SearchOrder:TLLVMOrcCJITDylibSearchOrder; SearchOrderSize:Tsize_t; Symbols:TLLVMOrcCLookupSet; 
            SymbolsSize:Tsize_t; HandleResult:TLLVMOrcExecutionSessionLookupHandleResultFunction; Ctx:pointer);cdecl;external;
{*
 * Increments the ref-count for a SymbolStringPool entry.
  }
procedure LLVMOrcRetainSymbolStringPoolEntry(S:TLLVMOrcSymbolStringPoolEntryRef);cdecl;external;
{*
 * Reduces the ref-count for of a SymbolStringPool entry.
  }
procedure LLVMOrcReleaseSymbolStringPoolEntry(S:TLLVMOrcSymbolStringPoolEntryRef);cdecl;external;
{*
...
(* Const before type ignored *)
function LLVMOrcSymbolStringPoolEntryStr(S:TLLVMOrcSymbolStringPoolEntryRef):Pchar;cdecl;external;
{*
 * Reduces the ref-count of a ResourceTracker.
  }
procedure LLVMOrcReleaseResourceTracker(RT:TLLVMOrcResourceTrackerRef);cdecl;external;
{*
 * Transfers tracking of all resources associated with resource tracker SrcRT
 * to resource tracker DstRT.
  }
procedure LLVMOrcResourceTrackerTransferTo(SrcRT:TLLVMOrcResourceTrackerRef; DstRT:TLLVMOrcResourceTrackerRef);cdecl;external;
{*
 * Remove all resources associated with the given tracker. See
 * ResourceTracker::remove().
  }
function LLVMOrcResourceTrackerRemove(RT:TLLVMOrcResourceTrackerRef):TLLVMErrorRef;cdecl;external;
{*
 * Dispose of a JITDylib::DefinitionGenerator. This should only be called if
 * ownership has not been passed to a JITDylib (e.g. because some error
 * prevented the client from calling LLVMOrcJITDylibAddGenerator).
  }
procedure LLVMOrcDisposeDefinitionGenerator(DG:TLLVMOrcDefinitionGeneratorRef);cdecl;external;
{*
 * Dispose of a MaterializationUnit.
  }
procedure LLVMOrcDisposeMaterializationUnit(MU:TLLVMOrcMaterializationUnitRef);cdecl;external;
{*
...
function LLVMOrcCreateCustomMaterializationUnit(Name:Pchar; Ctx:pointer; Syms:TLLVMOrcCSymbolFlagsMapPairs; NumSyms:Tsize_t; InitSym:TLLVMOrcSymbolStringPoolEntryRef; 
           Materialize:TLLVMOrcMaterializationUnitMaterializeFunction; Discard:TLLVMOrcMaterializationUnitDiscardFunction; Destroy:TLLVMOrcMaterializationUnitDestroyFunction):TLLVMOrcMaterializationUnitRef;cdecl;external;
{*
...
function LLVMOrcAbsoluteSymbols(Syms:TLLVMOrcCSymbolMapPairs; NumPairs:Tsize_t):TLLVMOrcMaterializationUnitRef;cdecl;external;
{*
...
function LLVMOrcLazyReexports(LCTM:TLLVMOrcLazyCallThroughManagerRef; ISM:TLLVMOrcIndirectStubsManagerRef; SourceRef:TLLVMOrcJITDylibRef; CallableAliases:TLLVMOrcCSymbolAliasMapPairs; NumPairs:Tsize_t):TLLVMOrcMaterializationUnitRef;cdecl;external;
...
procedure LLVMOrcDisposeMaterializationResponsibility(MR:TLLVMOrcMaterializationResponsibilityRef);cdecl;external;
{*
 * Returns the target JITDylib that these symbols are being materialized into.
  }
function LLVMOrcMaterializationResponsibilityGetTargetDylib(MR:TLLVMOrcMaterializationResponsibilityRef):TLLVMOrcJITDylibRef;cdecl;external;
{*
 * Returns the ExecutionSession for this MaterializationResponsibility.
  }
function LLVMOrcMaterializationResponsibilityGetExecutionSession(MR:TLLVMOrcMaterializationResponsibilityRef):TLLVMOrcExecutionSessionRef;cdecl;external;
{*
...
function LLVMOrcMaterializationResponsibilityGetSymbols(MR:TLLVMOrcMaterializationResponsibilityRef; NumPairs:Psize_t):TLLVMOrcCSymbolFlagsMapPairs;cdecl;external;
{*
 * Disposes of the passed LLVMOrcCSymbolFlagsMap.
 *
 * Does not release the entries themselves.
  }
procedure LLVMOrcDisposeCSymbolFlagsMap(Pairs:TLLVMOrcCSymbolFlagsMapPairs);cdecl;external;
{*
...
function LLVMOrcMaterializationResponsibilityGetInitializerSymbol(MR:TLLVMOrcMaterializationResponsibilityRef):TLLVMOrcSymbolStringPoolEntryRef;cdecl;external;
{*
...
function LLVMOrcMaterializationResponsibilityGetRequestedSymbols(MR:TLLVMOrcMaterializationResponsibilityRef; NumSymbols:Psize_t):PLLVMOrcSymbolStringPoolEntryRef;cdecl;external;
{*
 * Disposes of the passed LLVMOrcSymbolStringPoolEntryRef* .
 *
 * Does not release the symbols themselves.
  }
procedure LLVMOrcDisposeSymbols(Symbols:PLLVMOrcSymbolStringPoolEntryRef);cdecl;external;
{*
...
function LLVMOrcMaterializationResponsibilityNotifyResolved(MR:TLLVMOrcMaterializationResponsibilityRef; Symbols:TLLVMOrcCSymbolMapPairs; NumPairs:Tsize_t):TLLVMErrorRef;cdecl;external;
{*
...
function LLVMOrcMaterializationResponsibilityNotifyEmitted(MR:TLLVMOrcMaterializationResponsibilityRef; SymbolDepGroups:PLLVMOrcCSymbolDependenceGroup; NumSymbolDepGroups:Tsize_t):TLLVMErrorRef;cdecl;external;
{*
...
function LLVMOrcMaterializationResponsibilityDefineMaterializing(MR:TLLVMOrcMaterializationResponsibilityRef; Pairs:TLLVMOrcCSymbolFlagsMapPairs; NumPairs:Tsize_t):TLLVMErrorRef;cdecl;external;
{*
...
procedure LLVMOrcMaterializationResponsibilityFailMaterialization(MR:TLLVMOrcMaterializationResponsibilityRef);cdecl;external;
{*
...
function LLVMOrcMaterializationResponsibilityReplace(MR:TLLVMOrcMaterializationResponsibilityRef; MU:TLLVMOrcMaterializationUnitRef):TLLVMErrorRef;cdecl;external;
{*
...
function LLVMOrcMaterializationResponsibilityDelegate(MR:TLLVMOrcMaterializationResponsibilityRef; Symbols:PLLVMOrcSymbolStringPoolEntryRef; NumSymbols:Tsize_t; Result:PLLVMOrcMaterializationResponsibilityRef):TLLVMErrorRef;cdecl;external;
{*
...
(* Const before type ignored *)
function LLVMOrcExecutionSessionCreateBareJITDylib(ES:TLLVMOrcExecutionSessionRef; Name:Pchar):TLLVMOrcJITDylibRef;cdecl;external;
{*
 * Create a JITDylib.
 *
 * The client is responsible for ensuring that the JITDylib's name is unique,
...
(* Const before type ignored *)
function LLVMOrcExecutionSessionCreateJITDylib(ES:TLLVMOrcExecutionSessionRef; Result:PLLVMOrcJITDylibRef; Name:Pchar):TLLVMErrorRef;cdecl;external;
{*
 * Returns the JITDylib with the given name, or NULL if no such JITDylib
 * exists.
  }
(* Const before type ignored *)
function LLVMOrcExecutionSessionGetJITDylibByName(ES:TLLVMOrcExecutionSessionRef; Name:Pchar):TLLVMOrcJITDylibRef;cdecl;external;
{*
 * Return a reference to a newly created resource tracker associated with JD.
 * The tracker is returned with an initial ref-count of 1, and must be released
 * with LLVMOrcReleaseResourceTracker when no longer needed.
  }
function LLVMOrcJITDylibCreateResourceTracker(JD:TLLVMOrcJITDylibRef):TLLVMOrcResourceTrackerRef;cdecl;external;
{*
 * Return a reference to the default resource tracker for the given JITDylib.
 * This operation will increase the retain count of the tracker: Clients should
 * call LLVMOrcReleaseResourceTracker when the result is no longer needed.
  }
function LLVMOrcJITDylibGetDefaultResourceTracker(JD:TLLVMOrcJITDylibRef):TLLVMOrcResourceTrackerRef;cdecl;external;
{*
...
function LLVMOrcJITDylibDefine(JD:TLLVMOrcJITDylibRef; MU:TLLVMOrcMaterializationUnitRef):TLLVMErrorRef;cdecl;external;
{*
 * Calls remove on all trackers associated with this JITDylib, see
 * JITDylib::clear().
  }
function LLVMOrcJITDylibClear(JD:TLLVMOrcJITDylibRef):TLLVMErrorRef;cdecl;external;
{*
...
procedure LLVMOrcJITDylibAddGenerator(JD:TLLVMOrcJITDylibRef; DG:TLLVMOrcDefinitionGeneratorRef);cdecl;external;
{*
...
function LLVMOrcCreateCustomCAPIDefinitionGenerator(F:TLLVMOrcCAPIDefinitionGeneratorTryToGenerateFunction; Ctx:pointer; _Dispose:TLLVMOrcDisposeCAPIDefinitionGeneratorFunction):TLLVMOrcDefinitionGeneratorRef;cdecl;external;
{*
 * Continue a lookup that was suspended in a generator (see
 * LLVMOrcCAPIDefinitionGeneratorTryToGenerateFunction).
  }
procedure LLVMOrcLookupStateContinueLookup(S:TLLVMOrcLookupStateRef; Err:TLLVMErrorRef);cdecl;external;
{*
...
function LLVMOrcCreateDynamicLibrarySearchGeneratorForProcess(Result:PLLVMOrcDefinitionGeneratorRef; GlobalPrefx:char; Filter:TLLVMOrcSymbolPredicate; FilterCtx:pointer):TLLVMErrorRef;cdecl;external;
{*
...
(* Const before type ignored *)
function LLVMOrcCreateDynamicLibrarySearchGeneratorForPath(Result:PLLVMOrcDefinitionGeneratorRef; FileName:Pchar; GlobalPrefix:char; Filter:TLLVMOrcSymbolPredicate; FilterCtx:pointer):TLLVMErrorRef;cdecl;external;
{*
...
(* Const before type ignored *)
(* Const before type ignored *)
function LLVMOrcCreateStaticLibrarySearchGeneratorForPath(Result:PLLVMOrcDefinitionGeneratorRef; ObjLayer:TLLVMOrcObjectLayerRef; FileName:Pchar; TargetTriple:Pchar):TLLVMErrorRef;cdecl;external;
{*
...
function LLVMOrcCreateNewThreadSafeContext:TLLVMOrcThreadSafeContextRef;cdecl;external;
{*
 * Get a reference to the wrapped LLVMContext.
  }
function LLVMOrcThreadSafeContextGetContext(TSCtx:TLLVMOrcThreadSafeContextRef):TLLVMContextRef;cdecl;external;
{*
 * Dispose of a ThreadSafeContext.
  }
procedure LLVMOrcDisposeThreadSafeContext(TSCtx:TLLVMOrcThreadSafeContextRef);cdecl;external;
{*
...
function LLVMOrcCreateNewThreadSafeModule(M:TLLVMModuleRef; TSCtx:TLLVMOrcThreadSafeContextRef):TLLVMOrcThreadSafeModuleRef;cdecl;external;
{*
 * Dispose of a ThreadSafeModule. This should only be called if ownership has
 * not been passed to LLJIT (e.g. because some error prevented the client from
 * adding this to the JIT).
  }
procedure LLVMOrcDisposeThreadSafeModule(TSM:TLLVMOrcThreadSafeModuleRef);cdecl;external;
{*
 * Apply the given function to the module contained in this ThreadSafeModule.
  }
function LLVMOrcThreadSafeModuleWithModuleDo(TSM:TLLVMOrcThreadSafeModuleRef; F:TLLVMOrcGenericIRModuleOperationFunction; Ctx:pointer):TLLVMErrorRef;cdecl;external;
{*
...
function LLVMOrcJITTargetMachineBuilderDetectHost(Result:PLLVMOrcJITTargetMachineBuilderRef):TLLVMErrorRef;cdecl;external;
{*
...
function LLVMOrcJITTargetMachineBuilderCreateFromTargetMachine(TM:TLLVMTargetMachineRef):TLLVMOrcJITTargetMachineBuilderRef;cdecl;external;
{*
 * Dispose of a JITTargetMachineBuilder.
  }
procedure LLVMOrcDisposeJITTargetMachineBuilder(JTMB:TLLVMOrcJITTargetMachineBuilderRef);cdecl;external;
{*
...
function LLVMOrcJITTargetMachineBuilderGetTargetTriple(JTMB:TLLVMOrcJITTargetMachineBuilderRef):Pchar;cdecl;external;
{*
 * Sets the target triple for the given JITTargetMachineBuilder to the given
 * string.
  }
(* Const before type ignored *)
procedure LLVMOrcJITTargetMachineBuilderSetTargetTriple(JTMB:TLLVMOrcJITTargetMachineBuilderRef; TargetTriple:Pchar);cdecl;external;
{*
...
function LLVMOrcObjectLayerAddObjectFile(ObjLayer:TLLVMOrcObjectLayerRef; JD:TLLVMOrcJITDylibRef; ObjBuffer:TLLVMMemoryBufferRef):TLLVMErrorRef;cdecl;external;
{*
...
function LLVMOrcObjectLayerAddObjectFileWithRT(ObjLayer:TLLVMOrcObjectLayerRef; RT:TLLVMOrcResourceTrackerRef; ObjBuffer:TLLVMMemoryBufferRef):TLLVMErrorRef;cdecl;external;
{*
...
procedure LLVMOrcObjectLayerEmit(ObjLayer:TLLVMOrcObjectLayerRef; R:TLLVMOrcMaterializationResponsibilityRef; ObjBuffer:TLLVMMemoryBufferRef);cdecl;external;
{*
 * Dispose of an ObjectLayer.
  }
procedure LLVMOrcDisposeObjectLayer(ObjLayer:TLLVMOrcObjectLayerRef);cdecl;external;
procedure LLVMOrcIRTransformLayerEmit(IRTransformLayer:TLLVMOrcIRTransformLayerRef; MR:TLLVMOrcMaterializationResponsibilityRef; TSM:TLLVMOrcThreadSafeModuleRef);cdecl;external;
{*
 * Set the transform function of the provided transform layer, passing through a
 * pointer to user provided context.
  }
procedure LLVMOrcIRTransformLayerSetTransform(IRTransformLayer:TLLVMOrcIRTransformLayerRef; TransformFunction:TLLVMOrcIRTransformLayerTransformFunction; Ctx:pointer);cdecl;external;
{*
 * Set the transform function on an LLVMOrcObjectTransformLayer.
  }
procedure LLVMOrcObjectTransformLayerSetTransform(ObjTransformLayer:TLLVMOrcObjectTransformLayerRef; TransformFunction:TLLVMOrcObjectTransformLayerTransformFunction; Ctx:pointer);cdecl;external;
{*
...
(* Const before type ignored *)
function LLVMOrcCreateLocalIndirectStubsManager(TargetTriple:Pchar):TLLVMOrcIndirectStubsManagerRef;cdecl;external;
{*
 * Dispose of an IndirectStubsManager.
  }
procedure LLVMOrcDisposeIndirectStubsManager(ISM:TLLVMOrcIndirectStubsManagerRef);cdecl;external;
(* Const before type ignored *)
function LLVMOrcCreateLocalLazyCallThroughManager(TargetTriple:Pchar; ES:TLLVMOrcExecutionSessionRef; ErrorHandlerAddr:TLLVMOrcJITTargetAddress; LCTM:PLLVMOrcLazyCallThroughManagerRef):TLLVMErrorRef;cdecl;external;
{*
 * Dispose of an LazyCallThroughManager.
  }
procedure LLVMOrcDisposeLazyCallThroughManager(LCTM:TLLVMOrcLazyCallThroughManagerRef);cdecl;external;
{*
...
(* Const before type ignored *)
(* Const before type ignored *)
function LLVMOrcCreateDumpObjects(DumpDir:Pchar; IdentifierOverride:Pchar):TLLVMOrcDumpObjectsRef;cdecl;external;
{*
 * Dispose of a DumpObjects instance.
  }
procedure LLVMOrcDisposeDumpObjects(DumpObjects:TLLVMOrcDumpObjectsRef);cdecl;external;
{*
 * Dump the contents of the given MemoryBuffer.
  }
function LLVMOrcDumpObjects_CallOperator(DumpObjects:TLLVMOrcDumpObjectsRef; ObjBuffer:PLLVMMemoryBufferRef):TLLVMErrorRef;cdecl;external;
{*
 * @
  }
{$endif}
