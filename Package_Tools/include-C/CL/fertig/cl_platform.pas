 ...
 *          Maintaining proper alignment is the user's responsibility.
  ...
  P_cl_float4 = ^T_cl_float4;
  T_cl_float4 = single;

  P_cl_uchar16 = ^T_cl_uchar16;
  T_cl_uchar16 = Tcl_uchar;

  P_cl_char16 = ^T_cl_char16;
  T_cl_char16 = Tcl_char;

  P_cl_ushort8 = ^T_cl_ushort8;
  T_cl_ushort8 = Tcl_ushort;

  P_cl_short8 = ^T_cl_short8;
  T_cl_short8 = Tcl_short;

  P_cl_uint4 = ^T_cl_uint4;
  T_cl_uint4 = Tcl_uint;

  P_cl_int4 = ^T_cl_int4;
  T_cl_int4 = Tcl_int;

  P_cl_ulong2 = ^T_cl_ulong2;
  T_cl_ulong2 = Tcl_ulong;

  P_cl_long2 = ^T_cl_long2;
  T_cl_long2 = Tcl_long;

  P_cl_double2 = ^T_cl_double2;
  T_cl_double2 = Tcl_double;
...
const
  ...
  __CL_DOUBLE2__ = 1;  
type
  P_cl_uchar8 = ^T_cl_uchar8;
  T_cl_uchar8 = Tcl_uchar;

  P_cl_char8 = ^T_cl_char8;
  T_cl_char8 = Tcl_char;

  P_cl_ushort4 = ^T_cl_ushort4;
  T_cl_ushort4 = Tcl_ushort;

  P_cl_short4 = ^T_cl_short4;
  T_cl_short4 = Tcl_short;

  P_cl_uint2 = ^T_cl_uint2;
  T_cl_uint2 = Tcl_uint;

  P_cl_int2 = ^T_cl_int2;
  T_cl_int2 = Tcl_int;

  P_cl_ulong1 = ^T_cl_ulong1;
  T_cl_ulong1 = Tcl_ulong;

  P_cl_long1 = ^T_cl_long1;
  T_cl_long1 = Tcl_long;

  P_cl_float2 = ^T_cl_float2;
  T_cl_float2 = Tcl_float;
...
{ cl_char3 is identical in size, alignment and behavior to cl_char4. See section 6.1.5.  }
  ...
  Tcl_char8 = record
      case longint of
        ...
        4 : ( v2 : array[0..3] of Tcl_char2 );
        5 : ( v4 : array[0..1] of Tcl_char4 );
        6 : ( v8 : Tcl_char8 );
      end;
  ...
  Tcl_char16 = record
      case longint of
        ...
        4 : ( v2 : array[0..7] of Tcl_char2 );
        5 : ( v4 : array[0..3] of Tcl_char4 );
        6 : ( v8 : array[0..1] of Tcl_char8 );
        7 : ( v16 : Tcl_char16 );
      end;
{ ---- cl_ucharn ----  }
...
{ cl_uchar3 is identical in size, alignment and behavior to cl_uchar4. See section 6.1.5.  }
  ...
  Tcl_uchar8 = record
      case longint of
        ...
        4 : ( v2 : array[0..3] of Tcl_uchar2 );
        5 : ( v4 : array[0..1] of Tcl_uchar4 );
        6 : ( v8 : Tcl_uchar8 );
      end;
  ...
  Tcl_uchar16 = record
      case longint of
        ...
        4 : ( v2 : array[0..7] of Tcl_uchar2 );
        5 : ( v4 : array[0..3] of Tcl_uchar4 );
        6 : ( v8 : array[0..1] of Tcl_uchar8 );
        7 : ( v16 : Tcl_uchar16 );
      end;
{ ---- cl_shortn ----  }
...
{ cl_short3 is identical in size, alignment and behavior to cl_short4. See section 6.1.5.  }
  ...
  Tcl_short8 = record
      case longint of
        ...
        4 : ( v2 : array[0..3] of Tcl_short2 );
        5 : ( v4 : array[0..1] of Tcl_short4 );
        6 : ( v8 : Tcl_short8 );
      end;
  ...
  Tcl_short16 = record
      case longint of
        ...
        4 : ( v2 : array[0..7] of Tcl_short2 );
        5 : ( v4 : array[0..3] of Tcl_short4 );
        6 : ( v8 : array[0..1] of Tcl_short8 );
        7 : ( v16 : Tcl_short16 );
      end;
{ ---- cl_ushortn ----  }
...
{ cl_ushort3 is identical in size, alignment and behavior to cl_ushort4. See section 6.1.5.  }
  ...
  Tcl_ushort8 = record
      case longint of
        ...
        4 : ( v2 : array[0..3] of Tcl_ushort2 );
        5 : ( v4 : array[0..1] of Tcl_ushort4 );
        6 : ( v8 : Tcl_ushort8 );
      end;
  ...
  Tcl_ushort16 = record
      case longint of
        ...
        4 : ( v2 : array[0..7] of Tcl_ushort2 );
        5 : ( v4 : array[0..3] of Tcl_ushort4 );
        6 : ( v8 : array[0..1] of Tcl_ushort8 );
        7 : ( v16 : Tcl_ushort16 );
      end;
{ ---- cl_halfn ----  }
...
{ cl_half3 is identical in size, alignment and behavior to cl_half4. See section 6.1.5.  }
  ...
  Tcl_half8 = record
      case longint of
        ...
        4 : ( v2 : array[0..3] of Tcl_half2 );
        5 : ( v4 : array[0..1] of Tcl_half4 );
        6 : ( v8 : Tcl_half8 );
      end;
  ...
  Tcl_half16 = record
      case longint of
        ...
        4 : ( v2 : array[0..7] of Tcl_half2 );
        5 : ( v4 : array[0..3] of Tcl_half4 );
        6 : ( v8 : array[0..1] of Tcl_half8 );
        7 : ( v16 : Tcl_half16 );
      end;
{ ---- cl_intn ----  }
...
{ cl_int3 is identical in size, alignment and behavior to cl_int4. See section 6.1.5.  }
  ...
  Tcl_int8 = record
      case longint of
        ...
        4 : ( v2 : array[0..3] of Tcl_int2 );
        5 : ( v4 : array[0..1] of Tcl_int4 );
        6 : ( v8 : Tcl_int8 );
      end;
  ...
  Tcl_int16 = record
      case longint of
        ...
        4 : ( v2 : array[0..7] of Tcl_int2 );
        5 : ( v4 : array[0..3] of Tcl_int4 );
        6 : ( v8 : array[0..1] of Tcl_int8 );
        7 : ( v16 : Tcl_int16 );
      end;
{ ---- cl_uintn ----  }
...
{ cl_uint3 is identical in size, alignment and behavior to cl_uint4. See section 6.1.5.  }
  ...
  Tcl_uint8 = record
      case longint of
        ...
        4 : ( v2 : array[0..3] of Tcl_uint2 );
        5 : ( v4 : array[0..1] of Tcl_uint4 );
        6 : ( v8 : Tcl_uint8 );
      end;
  ...
  Tcl_uint16 = record
      case longint of
        ...
        4 : ( v2 : array[0..7] of Tcl_uint2 );
        5 : ( v4 : array[0..3] of Tcl_uint4 );
        6 : ( v8 : array[0..1] of Tcl_uint8 );
        7 : ( v16 : Tcl_uint16 );
      end;
{ ---- cl_longn ----  }
...
{ cl_long3 is identical in size, alignment and behavior to cl_long4. See section 6.1.5.  }
  ...
  Tcl_long8 = record
      case longint of
        ...
        4 : ( v2 : array[0..3] of Tcl_long2 );
        5 : ( v4 : array[0..1] of Tcl_long4 );
        6 : ( v8 : Tcl_long8 );
      end;
  ...
  Tcl_long16 = record
      case longint of
        ...
        4 : ( v2 : array[0..7] of Tcl_long2 );
        5 : ( v4 : array[0..3] of Tcl_long4 );
        6 : ( v8 : array[0..1] of Tcl_long8 );
        7 : ( v16 : Tcl_long16 );
      end;
{ ---- cl_ulongn ----  }
...
{ cl_ulong3 is identical in size, alignment and behavior to cl_ulong4. See section 6.1.5.  }
  ...
  Tcl_ulong8 = record
      case longint of
        ...
        4 : ( v2 : array[0..3] of Tcl_ulong2 );
        5 : ( v4 : array[0..1] of Tcl_ulong4 );
        6 : ( v8 : Tcl_ulong8 );
      end;
  ...
  Tcl_ulong16 = record
      case longint of
        ...
        4 : ( v2 : array[0..7] of Tcl_ulong2 );
        5 : ( v4 : array[0..3] of Tcl_ulong4 );
        6 : ( v8 : array[0..1] of Tcl_ulong8 );
        7 : ( v16 : Tcl_ulong16 );
      end;
{ --- cl_floatn ----  }
...
{ cl_float3 is identical in size, alignment and behavior to cl_float4. See section 6.1.5.  }
  ...
  Tcl_float8 = record
      case longint of
        ...
        4 : ( v2 : array[0..3] of Tcl_float2 );
        5 : ( v4 : array[0..1] of Tcl_float4 );
        6 : ( v8 : Tcl_float8 );
      end;
  ...
  Tcl_float16 = record
      case longint of
        ...
        4 : ( v2 : array[0..7] of Tcl_float2 );
        5 : ( v4 : array[0..3] of Tcl_float4 );
        6 : ( v8 : array[0..1] of Tcl_float8 );
        7 : ( v16 : Tcl_float16 );
      end;
{ --- cl_doublen ----  }
...
{ cl_double3 is identical in size, alignment and behavior to cl_double4. See section 6.1.5.  }
  ...
  Tcl_double8 = record
      case longint of
        ...
        4 : ( v2 : array[0..3] of Tcl_double2 );
        5 : ( v4 : array[0..1] of Tcl_double4 );
        6 : ( v8 : Tcl_double8 );
      end;
