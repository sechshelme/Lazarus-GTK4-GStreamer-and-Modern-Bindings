...
{
  Automatically converted by H2Pas 1.0.0 from atspi_document.h
...
PAtspiTextSelection  = ^AtspiTextSelection;
PGArray  = ^GArray;
Pgchar  = ^gchar;
PGError  = ^GError;
...
function ATSPI_TYPE_DOCUMENT : longint; { return type might be wrong }

{ was #define dname(params) para_def_expr }
{ argument types are unknown }
{ return type might be wrong }   
function ATSPI_DOCUMENT(obj : longint) : longint;

{ was #define dname(params) para_def_expr }
{ argument types are unknown }
{ return type might be wrong }   
function ATSPI_IS_DOCUMENT(obj : longint) : longint;

{ was #define dname(params) para_def_expr }
{ argument types are unknown }
{ return type might be wrong }   
function ATSPI_DOCUMENT_GET_IFACE(obj : longint) : longint;

function atspi_document_get_type:TGType;cdecl;external;
{*
 * AtspiTextSelection:
...
function atspi_document_get_locale(obj:PAtspiDocument; error:PPGError):Pgchar;cdecl;external;
{$ifndef ATSPI_DISABLE_DEPRECATED}
(* Const before type ignored *)

function atspi_document_get_attribute_value(obj:PAtspiDocument; attribute:Pgchar; error:PPGError):Pgchar;cdecl;external;
{$endif}
(* Const before type ignored *)

function atspi_document_get_document_attribute_value(obj:PAtspiDocument; attribute:Pgchar; error:PPGError):Pgchar;cdecl;external;
{$ifndef ATSPI_DISABLE_DEPRECATED}

function atspi_document_get_attributes(obj:PAtspiDocument; error:PPGError):PGHashTable;cdecl;external;
{$endif}

function atspi_document_get_document_attributes(obj:PAtspiDocument; error:PPGError):PGHashTable;cdecl;external;
function atspi_document_get_page_count(obj:PAtspiDocument; error:PPGError):Tgint;cdecl;external;
function atspi_document_get_current_page_number(obj:PAtspiDocument; error:PPGError):Tgint;cdecl;external;
function atspi_document_get_text_selections(document:PAtspiDocument; error:PPGError):PGArray;cdecl;external;
function atspi_document_set_text_selections(document:PAtspiDocument; selections:PGArray; error:PPGError):Tgboolean;cdecl;external;
{$endif}
{ _ATSPI_DOCUMENT_H_  }
...
function ATSPI_DOCUMENT(obj : longint) : longint;
begin
  ATSPI_DOCUMENT:=G_TYPE_CHECK_INSTANCE_CAST(obj,ATSPI_TYPE_DOCUMENT,AtspiDocument);
end;
...
function ATSPI_IS_DOCUMENT(obj : longint) : longint;
begin
  ATSPI_IS_DOCUMENT:=G_TYPE_CHECK_INSTANCE_TYPE(obj,ATSPI_TYPE_DOCUMENT);
end;
...
function ATSPI_DOCUMENT_GET_IFACE(obj : longint) : longint;
begin
  ATSPI_DOCUMENT_GET_IFACE:=G_TYPE_INSTANCE_GET_INTERFACE(obj,ATSPI_TYPE_DOCUMENT,AtspiDocument);
end;
